...
function EditPost() {
  ...
  // state
  const [postIdFromRouter, setPostIdFromRouter] = useState(""); // Rename postId to postIdFromRouter
  ...
  const handlePublish = async () => {
    try {
      ...
      console.log(err);
      toast.error("Post edit failed. Try again.");
      setLoading(false);
    }
  };
